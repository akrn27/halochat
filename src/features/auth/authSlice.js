...
export const createPost = createAsyncThunk("createP/createPost", async ({description, config}) => {
    const response = await axios.post(`https://paace-f178cafcae7b.nevacloud.io/api/post`, {description}, config)
    return response;
})
